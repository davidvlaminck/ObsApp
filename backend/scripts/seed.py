...
def seed_static_class_observations():
    seeded_class_observations = [
        ...
        ("woorden lezen", 2, "voldoende", date(2025, 7, 1), None),
        ("woorden lezen", 3, "voorsprong", date(2025, 7, 1), None),
        ("vormen herkennen", 4, "onvoldoende", date(2025, 7, 1), None),
        ...
        ("woorden lezen", 0, "voldoende", date(2025, 10, 20), None),
        ("woorden lezen", 1, "voorsprong", date(2025, 10, 21), None),
        ("woorden lezen", 2, "in_ontwikkeling", date(2025, 10, 22), None),
        ("woorden lezen", 3, "voldoende", date(2025, 10, 23), None),
        ("woorden lezen", 4, "voorsprong", date(2025, 10, 24), None),
        ("woorden lezen", 5, "onvoldoende", date(2025, 10, 25), None),
        ("woorden lezen", 6, "in_ontwikkeling", date(2025, 10, 26), None),
        ("woorden lezen", 7, "voldoende", date(2025, 10, 27), None),
        ("woorden lezen", 8, "voorsprong", date(2025, 10, 28), None),
        ("woorden lezen", 9, "in_ontwikkeling", date(2025, 10, 29), None),
        ("woorden lezen", 10, "voldoende", date(2025, 10, 30), None),
        ("woorden lezen", 11, "voorsprong", date(2025, 10, 31), None),
        ("woorden lezen", 12, "onvoldoende", date(2025, 11, 1), None),
        ("woorden lezen", 13, "in_ontwikkeling", date(2025, 11, 2), None),
        ("woorden lezen", 14, "voldoende", date(2025, 11, 3), None),
        ...
        ("vormen herkennen", 0, "voorsprong", date(2025, 12, 4), None),
        ("vormen herkennen", 1, "in_ontwikkeling", date(2025, 12, 5), None),
        ("vormen herkennen", 2, "voldoende", date(2025, 12, 6), None),
        ("vormen herkennen", 3, "voorsprong", date(2025, 12, 7), None),
        ("vormen herkennen", 4, "onvoldoende", date(2025, 12, 8), None),
        ("vormen herkennen", 5, "in_ontwikkeling", date(2025, 12, 9), None),
        ("vormen herkennen", 6, "voldoende", date(2025, 12, 10), None),
        ("vormen herkennen", 7, "voorsprong", date(2025, 12, 11), None),
        ("vormen herkennen", 8, "in_ontwikkeling", date(2025, 12, 12), None),
        ("vormen herkennen", 9, "voldoende", date(2025, 12, 13), None),
        ("vormen herkennen", 10, "voorsprong", date(2025, 12, 14), None),
        ("vormen herkennen", 11, "onvoldoende", date(2025, 12, 15), None),
        ("vormen herkennen", 12, "in_ontwikkeling", date(2025, 12, 16), None),
        ("vormen herkennen", 13, "voldoende", date(2025, 12, 17), None),
        ("vormen herkennen", 14, "voorsprong", date(2025, 12, 18), None),
    ]
