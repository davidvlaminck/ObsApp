...
class User(Base):
    ...
    membership_pending = Column(Boolean, default=False)
    pending_koepel = Column(String, nullable=True)
    pending_school_id = Column(Integer, ForeignKey("schools.id"), nullable=True)
